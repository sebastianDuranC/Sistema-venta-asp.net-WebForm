<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Clientes.aspx.cs" Inherits="CapaPresentacion.Pages.Clientes.Clientes" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="flex w-full flex-col justify-between py-4">
        <div class="mb-4 flex items-center justify-between">
            <h2 class="text-3xl font-extrabold text-primary">Gestion de Clientes</h2>
            <asp:Button
                ID="btnCrearNuevo"
                runat="server"
                Text="Crear cliente "
    ...
    <div class="flex rounded-lg bg-white p-4">
        <div class="flex w-full flex-col justify-between">
            ...
            <asp:Repeater runat="server" ID="rptCliente" OnItemCommand="rptCliente_ItemCommand">
                <%-- Cabecera de la tabla --%>
                <HeaderTemplate>
                    <table class="w-full table-auto border-collapse overflow-hidden rounded-lg shadow" id="tbCliente" style="width: 100%">
                        <thead>
                            <tr class="bg-primary text-center text-white">
                                <th class="py-2">#</th>
                                <th class="py-2">Nombre</th>
                                <th class="py-2">Numero local</th>
                                <th class="py-2">Pasillo</th>
                ...
                <ItemTemplate>
                    <tr class="text-center transition-colors hover:bg-gray-100">
                        ...
                        <td class="px-4 py-2"><%# Eval("NumeroLocal") %></td>
                        <td class="px-4 py-2"><%# Eval("Pasillo") %></td>
