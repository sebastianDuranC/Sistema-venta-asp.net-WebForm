<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegistrarCliente.aspx.cs" Inherits="CapaPresentacion.Pages.Clientes.RegistrarCliente" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <main class="container mx-auto px-4 py-8">
        <div class="mx-auto max-w-3xl rounded-lg bg-white p-8 shadow-xl">
            <h1 class="mb-6 text-2xl font-bold text-gray-800">Registrar Nuevo Cliente</h1>
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div>
                    ...
                    <div class="mb-4">
                        ...
                        <asp:TextBox ID="txtPasillo" runat="server" CssClass="w-full appearance-none rounded border px-3 py-2 leading-tight text-gray-700 shadow focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Ej. A-Z"></asp:TextBox>
                    </div>
                </div>
