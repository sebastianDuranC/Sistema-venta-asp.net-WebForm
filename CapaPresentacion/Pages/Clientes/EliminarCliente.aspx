<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EliminarCliente.aspx.cs" Inherits="CapaPresentacion.Pages.Clientes.EliminarCliente" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="flex w-full flex-col items-center justify-center py-8">
        <div class="w-full max-w-lg rounded-lg bg-white p-6 shadow-lg">
            <h2 class="mb-4 text-center text-3xl font-extrabold text-gray-800">Eliminar Cliente</h2>

            <asp:Repeater runat="server" ID="rptCliente">
                <ItemTemplate>
                    <div class="mb-6 border-b border-t border-gray-200 py-4">
                        ...
                        <div class="flex justify-between py-2">
                            <span class="font-semibold text-gray-700">Nombre de cliente:</span>
                            <span class="text-gray-900"><%# Eval("Nombre") %></span>
                        </div>
                        <div class="flex justify-between py-2">
                            <span class="font-semibold text-gray-700">Numero de local: </span>
                            <span class="text-gray-900"><%# Eval("NumeroLocal") %></span>
                        </div>
                        <div class="flex justify-between py-2">
                            <span class="font-semibold text-gray-700">Pasillo: </span>
                            <span class="text-gray-900"><%# Eval("Pasillo") %></span>
                        </div>
                    </div>
                    <%-- Botones de acción --%>
    ...
    <script>
        ...
        function eliminar(Id) {
            $.ajax({
                type: "POST",
                url: "/Pages/Clientes/EliminarClienteHandler.ashx",
                data: { Id: Id },
                dataType: "json",
