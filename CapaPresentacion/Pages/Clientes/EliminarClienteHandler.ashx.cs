...
{
    /// <summary>
    /// Descripción breve de EliminarClienteHandler
    /// </summary>
    public class EliminarClienteHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                // Intentar eliminar el registro del cliente
                bool resultado = obj.EliminarCliente(Id);
