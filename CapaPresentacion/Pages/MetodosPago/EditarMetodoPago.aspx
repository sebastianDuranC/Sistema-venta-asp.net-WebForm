<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditarMetodoPago.aspx.cs" Inherits="CapaPresentacion.Pages.MetodosPago.EditarMetodoPago" %>
    ...
    <div class="mx-auto max-w-2xl rounded-xl border border-gray-200 bg-white shadow-lg">
        ...
        <div class="p-6">
            <div class="space-y-6">
                ...
                <div>
                    <label for="<%= txtNombre.ClientID %>" class="mb-2 block text-sm font-medium text-gray-700">Nombre del Método:</label>
