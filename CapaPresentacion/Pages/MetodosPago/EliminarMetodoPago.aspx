<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EliminarMetodoPago.aspx.cs" Inherits="CapaPresentacion.Pages.MetodosPago.EliminarMetodoPago" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="flex w-full flex-col items-center justify-center py-8">
        <div class="w-full max-w-lg rounded-lg bg-white p-6 shadow-lg">
            ...
            <asp:Repeater runat="server" ID="rptMetodoPago">
                <ItemTemplate>
    ...
    <script>
        ...
        function eliminar(Id) {
            $.ajax({
                type: "POST",
                url: "/Pages/MetodosPago/EliminarMetodoPagoHandler.ashx",
                data: { Id: Id },
                dataType: "json",
                success: function (respuesta) {
                    if (respuesta.exito) {
                        Swal.fire({
                            ...
                            window.location.href = "MetodosPago.aspx"
                        });
                    } else {
