...
{
    /// <summary>
    /// Descripción breve de EliminarMetodoPagoHandler
    /// </summary>
    public class EliminarMetodoPagoHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                {
                    throw new Exception("El ID del metodo pago no es válido");
                }

                // Crear instancia de la capa de negocio
                MetodoPagoBLL obj = new MetodoPagoBLL();

                // Intentar eliminar el producto
                bool resultado = obj.EliminarMetodoPago(Id);
