<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Proveedores.aspx.cs" Inherits="CapaPresentacion.Pages.Proveedores.Proveedores" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <%-- Encabezado de la página: Título y Botón de Crear --%>
    <div class="flex w-full flex-col justify-between py-4">
        <div class="mb-4 flex items-center justify-between">
            <h2 class="text-3xl font-extrabold text-primary">Gestion de Proveedores</h2>
            <asp:Button
                ID="btnCrearNuevo"
                runat="server"
                Text="Crear "
    ...
    <div class="flex rounded-lg bg-white p-4">
        <div class="flex w-full flex-col justify-between">
            ...
            <asp:Repeater runat="server" ID="rptProveedores" OnItemCommand="rptProveedores_ItemCommand" ItemType="CapaEntidades.Proveedor">
                <%-- Cabecera de la tabla --%>
                <HeaderTemplate>
                    <table class="w-full table-auto border-collapse overflow-hidden rounded-lg shadow" id="tbProveedores" style="width: 100%">
                        <thead>
                        ...
                        <td class="px-4 py-2">
                            <div style="display: flex; gap: 0.5rem;">
                                ...
                                <asp:Button runat="server" Text="Ver"
                                    CommandName="Ver" CommandArgument='<%# Item.Id %> '
                                ...
                                <asp:Button runat="server" Text="Editar"
                                    CommandName="Editar" CommandArgument='<%# Item.Id %> '
                                ...
                                <asp:Button runat="server" Text="Eliminar"
                                    CommandName="Eliminar" CommandArgument='<%# Item.Id %> '
