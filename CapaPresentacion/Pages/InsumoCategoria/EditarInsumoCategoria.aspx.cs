...
{
    public partial class EditarInsumoCategoria : System.Web.UI.Page
    {
        ...
        private void cargarDatos(int id)
        {
            ...
            txtNombre.Text = insumoCategoria.Nombre;
        }
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                bool resultado = insumoCategoriaBLL.EditarInsumoCategoria(insumoCategoria);
                if (resultado)
                {
                    ShowToast("Editado correctamente", "success", "InsumoCategorias.aspx");
                }
                else
                {
