<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EliminarInsumoCategoria.aspx.cs" Inherits="CapaPresentacion.Pages.InsumoCategoria.EliminarInsumoCategoria" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="flex w-full flex-col items-center justify-center py-8">
        <div class="w-full max-w-lg rounded-lg bg-white p-6 shadow-lg">
            <h2 class="mb-4 text-center text-3xl font-extrabold text-gray-800">Eliminar Categoria de Insumos</h2>

            <asp:Repeater runat="server" ID="rptInsumoCategorias">
                <ItemTemplate>
