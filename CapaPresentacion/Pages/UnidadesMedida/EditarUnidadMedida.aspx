    ...
    <div class="w-full px-4 py-12">
        ...
        <div class="mx-auto max-w-2xl rounded-xl border border-gray-200 bg-white shadow-lg">
            ...
            <div class="border-b border-gray-200 p-6">
                <h1 class="text-2xl font-bold text-primary">Editar Unidad de Medida
            </h1>
            </div>
            ...
            <div class="p-6">
                <div class="space-y-6">
                    ...
                    <div>
                        <label for="<%= txtNombre.ClientID %>" class="mb-2 block text-sm font-medium text-gray-700">Nombre de la Unidad de Medida:</label>
                        <asp:TextBox ID="txtNombre" runat="server"
                            ...
                            placeholder="Ej: Efectivo"></asp:TextBox>
                    </div>
                    <div>
                        <label for="<%= txtAbreviacion.ClientID %>" class="mb-2 block text-sm font-medium text-gray-700">Abreviación:</label>
