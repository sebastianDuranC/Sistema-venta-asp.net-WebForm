<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegistrarUnidadMedida.aspx.cs" Inherits="CapaPresentacion.Pages.UnidadesMedida.RegistrarUnidadMedida" %>
    ...
    <section class="w-full px-4 py-12">
        ...
        <div class="mx-auto max-w-2xl rounded-xl border border-gray-200 bg-white shadow-lg">
            ...
            <div class="flex items-center gap-1 border-b border-gray-200 p-6">
                <div>
                    <img src="/wwwroot/images/icons/icon-registrar.png" alt="icon mas" class="h-15 w-15 mr-2 rounded-[50px] object-contain" />
                </div>
                <div>
                    <h1 class="text-primary text-2xl font-bold">Registrar Unidad de Medida</h1>
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 gap-x-6 gap-y-8 md:grid-cols-2">
                    ...
                    <div class="md:col-span-1">
                        <label for="<%= txtAbreviatura.ClientID %>" class="mb-2 block text-sm font-medium text-gray-700">Abreviatura:</label>
