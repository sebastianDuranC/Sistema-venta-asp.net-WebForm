<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MovimientosInventario.aspx.cs" Inherits="CapaPresentacion.Pages.MovimientoInventario.MovimientosInventario" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <%-- Encabezado de la página: Título y Botón de Crear --%>
    <div class="flex w-full flex-col justify-between py-4">
        <div class="mb-4 flex items-center justify-between">
            <h2 class="text-3xl font-extrabold text-primary">Gestion de Movimientos de Inventario</h2>
            <asp:Button
                ID="btnCrearNuevo"
                runat="server"
                Text="Crear "
    ...
    <div class="flex rounded-lg bg-white p-4">
        <div class="flex w-full flex-col justify-between">
            ...
            <asp:Repeater runat="server" ID="rptMoviientoInventario" OnItemCommand="rptMoviientoInventario_ItemCommand">
                <%-- Cabecera de la tabla --%>
                <HeaderTemplate>
                    <table class="w-full table-auto border-collapse overflow-hidden rounded-lg shadow" id="tbMovimientoInventario" style="width: 100%">
                        <thead>
                ...
                <ItemTemplate>
                    <tr class="transition-colors hover:bg-gray-100">
                        ...
                        <td class="px-4 py-2"><%# Eval("Insumo.Nombre") %></td>
                        <td class="px-4 py-2"><%# Eval("TipoMovimiento") %></td>
                        <td class="px-4 py-2"><%# Eval("Cantidad") %></td>
                        <td class="px-4 py-2"><%# Eval("Observacion") %></td>
                        <td class="px-4 py-2"><%# Eval("Usuario.Nombre") %></td>
    ...
    <script>
        ...
        $(document).ready(function () {
            $('#tbMovimientoInventario').DataTable({
