<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Compras.aspx.cs" Inherits="CapaPresentacion.Pages.Compras.Compras" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <%-- Encabezado de la página: Título y Botón de Crear --%>
    <div class="flex w-full flex-col justify-between py-4">
        <div class="mb-4 flex items-center justify-between">
            <h2 class="text-3xl font-extrabold text-primary">Gestion de Compras</h2>
            <asp:Button
                ID="btnCrearNuevo"
                runat="server"
                Text="Crear "
    ...
    <div class="flex rounded-lg bg-white p-4">
        <div class="flex w-full flex-col justify-between">
            ...
            <asp:Repeater runat="server" ID="rptCompras" OnItemCommand="rptCompras_ItemCommand">
                ...
                <HeaderTemplate>
                    <table class="w-full table-auto border-collapse overflow-hidden rounded-lg shadow" id="tbCompras" style="width: 100%">
                        <thead>
                            <tr class="bg-primary text-white">
                                <th class="py-2">Nº compra</th>
