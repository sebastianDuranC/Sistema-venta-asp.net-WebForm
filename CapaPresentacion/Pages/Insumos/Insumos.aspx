<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Insumos.aspx.cs" Inherits="CapaPresentacion.Pages.Insumos.Insumos" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <%-- Encabezado de la página: Título y Botón de Crear --%>
    <div class="flex w-full flex-col justify-between py-4">
        <div class="mb-4 flex items-center justify-between">
            <h2 class="text-3xl font-extrabold text-primary">Gestion de Insumos</h2>
            <asp:Button
                ID="btnCrearNuevo"
                runat="server"
                Text="Crear Insumo"
    ...
    <div class="flex rounded-lg bg-white p-4">
        <div class="flex w-full flex-col justify-between">
            ...
            <asp:Repeater runat="server" ID="rptInsumo" OnItemCommand="rptInsumo_ItemCommand">
                <%-- Cabecera de la tabla --%>
                <HeaderTemplate>
                    <table class="w-full table-auto border-collapse overflow-hidden rounded-lg shadow" id="tbInsumo" style="width: 100%">
                        <thead>
                ...
                <ItemTemplate>
                    <tr class="transition-colors hover:bg-gray-100">
                        ...
                        <td class="px-4 py-2"><%# Eval("Proveedor.Nombre") %></td>
                        <td class="px-4 py-2"><%# Eval("UnidadesMedida.Nombre") %></td>
