<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegistrarInsumo.aspx.cs" Inherits="CapaPresentacion.Pages.Insumos.RegistrarInsumo" %>
    ...
    <main class="w-full px-4 py-12">
        ...
        <div class="mx-auto max-w-2xl rounded-xl border border-gray-200 bg-white shadow-lg">
            ...
            <div class="border-b border-gray-200 p-6">
                <h1 class="text-2xl font-bold text-primary">Crear Nuevo Insumo
            </h1>
            </div>
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 gap-x-6 gap-y-8 md:grid-cols-2">
                    ...
                    <div class="md:col-span-1">
                        ...
                        <asp:TextBox ID="txtNombre" runat="server" placeholder="Ej. Pollo"
                            CssClass="block w-full rounded-md border-gray-300 px-3 py-2 text-gray-800 shadow-sm transition-colors placeholder:text-gray-400 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"></asp:TextBox>
                    </div>

                    <div class="md:col-span-1">
                        <label for="<%= txtCosto.ClientID %>" class="mb-2 block text-sm font-medium text-gray-700">Costo:</label>
                        <asp:TextBox ID="txtCosto" runat="server" TextMode="Number" placeholder="Ej. 30"
                            CssClass="block w-full rounded-md border-gray-300 px-3 py-2 text-gray-800 shadow-sm transition-colors placeholder:text-gray-400 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"></asp:TextBox>
                    </div>

                    <div class="md:col-span-1">
                        <label for="<%= txtStock.ClientID %>" class="mb-2 block text-sm font-medium text-gray-700">Stock:</label>
                        <asp:TextBox ID="txtStock" runat="server" TextMode="Number" placeholder="Ej. 30"
                            CssClass="block w-full rounded-md border-gray-300 px-3 py-2 text-gray-800 shadow-sm transition-colors placeholder:text-gray-400 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"></asp:TextBox>
                    </div>

                    <div class="md:col-span-1">
                        <label for="<%= txtStockMinimo.ClientID %>" class="mb-2 block text-sm font-medium text-gray-700">Stock minimo:</label>
                        <asp:TextBox ID="txtStockMinimo" runat="server" TextMode="Number" placeholder="Ej. 10"
                            CssClass="block w-full rounded-md border-gray-300 px-3 py-2 text-gray-800 shadow-sm transition-colors placeholder:text-gray-400 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"></asp:TextBox>
                    </div>

                    <div class="md:col-span-1">
                        <label for="<%= flUploadFoto.ClientID %>" class="mb-2 block text-sm font-medium text-gray-700">Foto de insumo:</label>
                        <asp:FileUpload runat="server" ID="flUploadFoto"/>
                    </div>

                    <div class="md:col-span-1">
                        <label for="InsumoCategoria.ClienteID" class="mb-2 block text-sm font-medium text-gray-700">Categoria:</label>
