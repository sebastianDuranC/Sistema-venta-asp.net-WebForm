<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegistrarRol.aspx.cs" Inherits="CapaPresentacion.Pages.Rol.RegistrarRol" %>
            ...
            <div class="p-6 sm:p-8">
                <div class="grid grid-cols-1 md:grid-cols-12 md:gap-12">
                    ...
                    <div class="md:col-span-5">
                        ...
                        <p class="mt-1 text-sm text-gray-600">Complete los datos básicos del nuevo rol.</p>
