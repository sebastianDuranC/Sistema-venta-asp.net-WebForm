...
<section class="w-full px-4 py-12">
        <div class="mx-auto max-w-2xl rounded-xl border border-gray-200 bg-white shadow-lg">
            ...
            <div class="flex items-center gap-1 border-b border-gray-200 p-6">
                ...
                <div>
                    <h1 class="text-primary text-2xl font-bold">Eliminar Usuario</h1>
                ...
                <ItemTemplate>
                    ...
                    <div class="flex items-center justify-end space-x-4 rounded-b-xl border-t border-gray-200 bg-gray-50 p-6">
                        ...
                        <asp:Button ID="btnCancelar" runat="server" Text="Cancelar" OnClick="btnCancelar_Click"
                            CssClass="bg-secondary cursor-pointer rounded-lg px-5 py-2.5 text-center text-sm font-medium text-white shadow-sm
                                        transition-all duration-200 hover:brightness-90 focus:ring-secondary focus:outline-none focus:ring-2 focus:ring-offset-2" />
