...
{
    public partial class EditarProductoCategorias : System.Web.UI.Page
    {
        ...
        {
            CapaEntidades.ProductoCategoria productoCategoria = productoCategoriaBLL.ObtenerCategoriaPorId(id);
            txtNombre.Text = productoCategoria.Nombre;
        }
        ...
        {
            CapaEntidades.ProductoCategoria productoCategori = new CapaEntidades.ProductoCategoria
            {
            ...
            try
            {
                bool resultado = productoCategoriaBLL.ActualizarProductoCategoria(productoCategori);
                if (resultado)
                {
                    ShowToast("Editado correctamente", "success", "ProductoCategorias.aspx");
                }
                else
                {
