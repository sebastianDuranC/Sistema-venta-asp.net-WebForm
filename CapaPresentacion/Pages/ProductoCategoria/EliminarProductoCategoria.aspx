<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EliminarProductoCategoria.aspx.cs" Inherits="CapaPresentacion.Pages.ProductoCategoria.EliminarProductoCategoria" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="flex w-full flex-col items-center justify-center py-8">
        <div class="w-full max-w-lg rounded-lg bg-white p-6 shadow-lg">
            <h2 class="mb-4 text-center text-3xl font-extrabold text-gray-800">Eliminar Categoria de Productos</h2>

            <asp:Repeater runat="server" ID="rptCategoriaProductos">
                <ItemTemplate>
                    <div class="mb-6 border-b border-t border-gray-200 py-4">
                        ...
                        <div class="flex justify-between py-2">
                            <span class="font-semibold text-gray-700">Nombre de categoria:</span>
    ...
    <script>
        ...
        function eliminar(Id) {
            $.ajax({
                type: "POST",
                url: "/Pages/ProductoCategoria/EliminarProductoCategoriasHandler.ashx",
                data: { Id: Id },
                dataType: "json",
                success: function (respuesta) {
                    if (respuesta.exito) {
                        Swal.fire({
                            ...
                            window.location.href = "ProductoCategorias.aspx"
                        });
                    } else {
